...
<body>
  <header>
    <div class="user-profile">
      <img src="assets/img/User-Profile-Pic.png	" alt="User Profile Picture" class="user--img" />
   ...
   <!--  <div class="search-bar">
      ...
      <input required type="search" name="#" id="#" placeholder="Search..." />
    </div> -->
  ...
  <main class="main-content-wrapper dashboard">
    <aside class="side-panel">
      <a href="index.php" class="active">
        ...
        Dashboard</a>
      <a href="src/teams.php"><svg xmlns="http://www.w3.org/2000/svg" width="30.857" height="27.429" viewBox="0 0 30.857 27.429">
          <path id="Icon_metro-users" data-name="Icon metro-users" d="M23.143,25.784V24.371A7.657,7.657,0,0,0,26.571,18c0-4.26,0-7.714-5.143-7.714S16.286,13.74,16.286,18a7.657,7.657,0,0,0,3.429,6.371v1.414C13.9,26.26,9.429,29.117,9.429,32.571h24c0-3.455-4.47-6.312-10.286-6.787Zm-11.807.662a16.287,16.287,0,0,1,5.351-2.154A9.67,9.67,0,0,1,15.6,22.711,9.816,9.816,0,0,1,14.357,18c0-2.3,0-4.482.82-6.261a5.581,5.581,0,0,1,4.265-3.2c-.453-2.049-1.659-3.4-4.87-3.4-5.143,0-5.143,3.454-5.143,7.714a7.657,7.657,0,0,0,3.429,6.371v1.414c-5.815.475-10.286,3.333-10.286,6.787h7.473a10.98,10.98,0,0,1,1.291-.982Z" transform="translate(-2.571 -5.143)" />
        </svg>
        Teams</a>
      <a href="src/schedule.php"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="31.5" viewBox="0 0 36 31.5">
          <path id="Icon_open-project" data-name="Icon open-project" d="M0,0V31.5H4.5V0ZM31.5,0V31.5H36V0ZM9,4.5V9h9V4.5Zm4.5,9V18h9V13.5Zm4.5,9V27h9V22.5Z" />
        </svg>
        Schedule</a>
      <a href="src/progress.php"><svg xmlns="http://www.w3.org/2000/svg" width="39.99" height="32.5" viewBox="0 0 39.99 32.5">
    ...
    <section class="admin-dashboard-content">
      ...
      <dialog id="addTeamModal">
        ...
        <form class="modal-form" enctype="multipart/form-data" action="/Software-Engineering-Local/src/app/helpers/processForm.php" method="post">
          <div>
            <h4 class="modal-title">Add Team</h4>
            <label for="TeamName">Team Name:</label>
            <input required name="TeamName" id="TeamName" type="text" />
            <label for="TeamImage">Team Icon:</label>
            <input required name="TeamImage" id="TeamImage" type="file" accept=".jpg, .jpeg, .png, .svg" />
          </div>
          <label for="TeamScore">Team Score:</label>
          <input required name="TeamScore" id="TeamScore" type="text" />
          <div class="flex-container">
            <button type="submit" class="submit-form" id="add-team" name="add-team">Submit</button>
      ...
      <dialog id="editTeamModal">
        ...
        <form class="modal-form" enctype="multipart/form-data" action="/Software-Engineering-Local/src/app/helpers/processForm.php" method="post">
          <div>
            ...
            <input required name="TeamID" id="TeamId" type="text" />
            <label for="TeamName">Team Name:</label>
            <input required name="TeamName" id="TeamName" type="text" />
          </div>
          <label for="TeamImage">Team Icon:</label>
          ...
          <input required name="TeamScore" id="TeamScore" type="text" />
          <div class="flex-container">
            <button type="submit" class="submit-form" id="edit-team" name="edit-team">Submit</button>
            <button class="modal-exit">Cancel</button>
          </div>
        </form>
      </dialog>
      ...
      <dialog id="addMilestoneModal">
        ...
        <form class="modal-form" enctype="multipart/form-data" action="/Software-Engineering-Local/src/app/helpers/processForm.php" method="post">
          <div>
            ...
            <input required name="TeamMilestone" id="TeamMilestone" type="text" />
            <label for="TeamMilestone">Milestone Description:</label>
            <input required name="TeamMilestoneDescription" id="TeamMilestoneDescription" type="text" />
          </div>
          <div class="flex-container">
            <button type="submit" type="submit" class="submit-form" id="add-milestone" name="add-milestone">Submit</button>
            <button class="modal-exit">Cancel</button>
          </div>
        </form>
      </dialog>
      ...
      <dialog id="editMilestoneModal">
        ...
        <form class="modal-form" enctype="multipart/form-data" action="/Software-Engineering-Local/src/app/helpers/processForm.php" method="post">
          <div>
            ...
            <label for="MilestoneID">Team ID:</label>
            <input required name="MilestoneID" id="MilestoneId" type="text" />
            <label for="TeamMilestone">Milestone:</label>
            <input required name="TeamMilestone" id="TeamMilestone" type="text" />
            <label for="TeamMilestone">Milestone Description:</label>
            <input required name="TeamMilestoneDescription" id="TeamMilestoneDescription" type="text" />
          ...
          <div class="flex-container">
            <button type="submit" class="submit-form" id="edit-milestone" name="edit-milestone">Submit</button>
            <button class="modal-exit">Cancel</button>
          </div>
        </form>
      </dialog>
